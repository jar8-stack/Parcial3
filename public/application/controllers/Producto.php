...
class Producto extends CI_Controller {
	...
	{
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'https://tienda450226.herokuapp.com/Producto');
		...
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'https://tienda450226.herokuapp.com/Proveedor');
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, true); 
		curl_setopt($ch, CURLOPT_HEADER, 0); 
		$data = curl_exec($ch); 
	...
	public function add(){
		...
		{
			$url = "https://tienda450226.herokuapp.com/Producto/".$resourcePath;
			//
			$ch = curl_init($url);
			curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
			if($method == "POST") {
	...
	public function delete($idProducto){
		$url = "https://tienda450226.herokuapp.com/Producto/".$idProducto;
    	$ch = curl_init();
