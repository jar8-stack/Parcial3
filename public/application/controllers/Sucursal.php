...
class Sucursal extends CI_Controller {
	...
	public function index()
	{
		...
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'https://tienda450226.herokuapp.com/Usuario');
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, true); 
		curl_setopt($ch, CURLOPT_HEADER, 0); 
		$data = curl_exec($ch); 
	...
	public function add(){
		...
		{
			$url = "https://tienda450226.herokuapp.com/Sucursal/".$resourcePath;
			//
			$ch = curl_init($url);
			curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
			if($method == "POST") {
	...
	public function delete($idSucursal){
		$url = "https://tienda450226.herokuapp.com/Sucursal/".$idSucursal;
    	$ch = curl_init();
