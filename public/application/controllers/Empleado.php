...
class Empleado extends CI_Controller {
	...
	{
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'https://tienda450226.herokuapp.com/Empleado');
		...
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_URL, 'https://tienda450226.herokuapp.com/Sucursal');
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, true); 
		curl_setopt($ch, CURLOPT_HEADER, 0); 
		$data = curl_exec($ch); 
	...
	public function add(){
		...
		{
			$url = "https://tienda450226.herokuapp.com/Empleado/".$resourcePath;
			//
			$ch = curl_init($url);
			curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
			if($method == "POST") {
	...
	public function delete($idEmpleado){
		$url = "https://tienda450226.herokuapp.com/Empleado/".$idEmpleado;
    	$ch = curl_init();
